  ...
  function load_links() {
    ...
    if ($this->lc_multi_site) {
      $this->lc_links_db_file = \Drupal::service('file_system')
        ->realpath(file_default_scheme() . "://link_partners/sape/$linkfeed_id/linkfeed.$host.links.db");
    }
    else {
      $this->lc_links_db_file = \Drupal::service('file_system')
        ->realpath(file_default_scheme() . "://link_partners/sape/$linkfeed_id/linkfeed.links.db");
    }
