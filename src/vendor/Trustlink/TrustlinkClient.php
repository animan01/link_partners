  ...
  function load_links() {
    ...
    if ($this->tl_multi_site) {
      $this->tl_links_db_file = \Drupal::service('file_system')
        ->realpath(file_default_scheme() . "://link_partners/sape/$trustlink_id/trustlink.$host.links.db");
    }
    else {
      $this->tl_links_db_file = \Drupal::service('file_system')
        ->realpath(file_default_scheme() . "://link_partners/sape/$trustlink_id/trustlink.links.db");
    }
